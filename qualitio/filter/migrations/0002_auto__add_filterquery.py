...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FilterQuery'
        db.create_table('filter_filterquery', (
            ...
            ('query', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('filter', ['FilterQuery'])


    def backwards(self, orm):
        
        # Deleting model 'FilterQuery'
        db.delete_table('filter_filterquery')
