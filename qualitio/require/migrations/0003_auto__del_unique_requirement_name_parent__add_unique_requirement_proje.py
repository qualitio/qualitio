...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Requirement', fields ['project', 'name', 'parent']
        db.create_unique('require_requirement', ['project_id', 'name', 'parent_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Requirement', fields ['project', 'name', 'parent']
        db.delete_unique('require_requirement', ['project_id', 'name', 'parent_id'])
    ...
    models = {
        ...
        'require.requirement': {
            'Meta': {'ordering': "('name',)", 'unique_together': "(('parent', 'name', 'project'),)", 'object_name': 'Requirement'},
