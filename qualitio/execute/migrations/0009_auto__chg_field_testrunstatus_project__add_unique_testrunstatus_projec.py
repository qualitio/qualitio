...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestRunStatus.project'
        db.alter_column('execute_testrunstatus', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Adding unique constraint on 'TestRunStatus', fields ['project', 'name']
        db.create_unique('execute_testrunstatus', ['project_id', 'name'])

        # Changing field 'TestCaseRun.project'
        db.alter_column('execute_testcaserun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'TestCaseRunStatus.project'
        db.alter_column('execute_testcaserunstatus', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'Bug.project'
        db.alter_column('execute_bug', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'TestCaseStepRun.project'
        db.alter_column('execute_testcasesteprun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'TestRunDirectory.project'
        db.alter_column('execute_testrundirectory', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'TestRun.project'
        db.alter_column('execute_testrun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))


    def backwards(self, orm):
        
        # Removing unique constraint on 'TestRunStatus', fields ['project', 'name']
        db.delete_unique('execute_testrunstatus', ['project_id', 'name'])

        # Changing field 'TestRunStatus.project'
        db.alter_column('execute_testrunstatus', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'TestCaseRun.project'
        db.alter_column('execute_testcaserun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'TestCaseRunStatus.project'
        db.alter_column('execute_testcaserunstatus', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'Bug.project'
        db.alter_column('execute_bug', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'TestCaseStepRun.project'
        db.alter_column('execute_testcasesteprun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'TestRunDirectory.project'
        db.alter_column('execute_testrundirectory', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))

        # Changing field 'TestRun.project'
        db.alter_column('execute_testrun', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))
