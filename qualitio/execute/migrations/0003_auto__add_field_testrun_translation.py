...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestRun.translation'
        db.add_column('execute_testrun', 'translation', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['glossary.Language']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'TestRun.translation'
        db.delete_column('execute_testrun', 'translation_id')
