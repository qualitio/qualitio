...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('execute_testcaserunstatus', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TestCaseRunStatus.name'
        db.alter_column('execute_testcaserunstatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))
