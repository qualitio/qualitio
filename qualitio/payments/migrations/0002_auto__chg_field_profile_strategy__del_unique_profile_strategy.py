...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Profile', fields ['strategy']
        db.delete_unique('payments_profile', ['strategy_id'])

        # Changing field 'Profile.strategy'
        db.alter_column('payments_profile', 'strategy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.Strategy']))


    def backwards(self, orm):
        
        # Changing field 'Profile.strategy'
        db.alter_column('payments_profile', 'strategy_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['payments.Strategy'], unique=True))

        # Adding unique constraint on 'Profile', fields ['strategy']
        db.create_unique('payments_profile', ['strategy_id'])
    ...
    models = {
        ...
        'payments.profile': {
            ...
            'strategy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['payments.Strategy']"}),
