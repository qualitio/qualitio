(function($){
    var Switcher = (function(selector){
        var selector = selector + ':not([disabled=disabled])';
        return {
            all: function(){
    ...
    var render = {
        ...
        prettyButton: function(){
            var html = '';
            html += '<div class="select-btn ui-state-default" style="padding:0px 2px 0px 2px;">';
    ...
    $.fn.itemsSelector = function(options){
        var opts = $.extend({
            ...
            menuItemStyle: 'padding:0px 5px 0px 5px;border:1px solid #fff;cursor: pointer;text-align:left;',
            menuItemHoverStyle: 'padding:0px 5px 0px 5px;background: #ccc;border: 1px solid #aaa;text-align:left;',
            selector: null
        }, options);
