...
class Test38ExecConnecttestname(BaseSeleniumTestCase):
    ...
    def test_38_exec_connecttestname(self):
        ...
        try: self.assertEqual("TestCase1", sel.get_table("css=div.dataTables_scrollBody > table.display.testcaserun-list.1.2"))
        except AssertionError, e: self.verificationErrors.append(str(e))
        try: self.assertEqual("TestCase1", sel.get_table("css=div.dataTables_scrollBody > table.display.testcaserun-list.2.2"))
        except AssertionError, e: self.verificationErrors.append(str(e))
        ...
        try: self.assertEqual("TestCase1", sel.get_table("css=div.dataTables_scrollBody > table.display.testcaserun-list.16.2"))
        except AssertionError, e: self.verificationErrors.append(str(e))
        sel.click("link=edit")
        for i in range(60):
            try:
...
class Test039ExecAddbug(BaseSeleniumTestCase):
    ...
    def test_039_exec_addbug(self):
        ...
        sel.type("css=div.dataTables_filter > input[type=text]", "")
        sel.click("//input[@value='1' and @type='checkbox']")
        for i in range(60):
            try:
                if sel.is_element_present("//a[@id='add-testcases-button']/span"): break
